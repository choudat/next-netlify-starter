      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            ...
            <p>
              ...
              standards. We ensure ethical alignment across external business
              goals, internal team dynamics, our technical stack, and the
        ...
        <div className={styles.grid}>
          <div className={styles.card}>
            <h2>Contact</h2>
            <p>
              To keep in touch, feel free to contact me on{" "}
              <a
            ...
            <p>
              ...
              <a href="/contact-me">Schedule a meeting</a> with me to explore
              how ConnEthics can support your initiatives.
            </p>
          </div>
        </div>
      </main>
